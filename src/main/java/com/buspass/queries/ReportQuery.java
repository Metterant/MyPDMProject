...
public class ReportQuery {
	...
	public List<LinkedHashMap<String, Object>> getUserCountsByRole() {
	...
	public List<LinkedHashMap<String, Object>> getAverageAgeByRole() {
	...
	public List<LinkedHashMap<String, Object>> getMostPopularRoutes(int limit) {
	...
	public List<LinkedHashMap<String, Object>> getTotalTicketsSoldPerDay() {
	...
	public List<LinkedHashMap<String, Object>> getTotalRevenuePerDay() {
	...
	public List<LinkedHashMap<String, Object>> getTopSpenders(int limit) {
	...
	public List<LinkedHashMap<String, Object>> getTotalTripsPerDriver() {
	...
	public List<LinkedHashMap<String, Object>> getBusUsageRate() {
	...
	public List<LinkedHashMap<String, Object>> getAverageRevenuePerRoute() {
